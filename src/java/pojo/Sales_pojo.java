...
public class Sales_pojo {
    ...
    @Column(name="transportationstate")
    private String transstate;
    
    @Column(name="transportationstatecode")
    private String transstatecode;
    
    @Column(name="transportationcity")
    private String transcity;    
    
    @Column(name="transportationaddress")
    private String transaddress;
    
    @Column(name="transportationpincode")
    private int transpincode;
...
//    
    ...
    public String gettransstatecode(){
        return transstatecode;
    }
    public int gettranspincode(){
        return transpincode;
    }
...
//    }
    ...
    public void settransstatecode(String transstatecode){
        this.transstatecode =  transstatecode;
    }
    public void settranspincode(int transpincode){
        this.transpincode =  transpincode;
    }
    ...
    public void setbillpincode(int billpin){
