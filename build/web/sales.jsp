...
/*            .pro_div button{
            ...
            .div_toggle,.delete,.editsales,.viewtrans{
                float: right;
                margin-left: 10px;
            }
            .iname+p{                
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#sal").click(function(){
                    $("#myModal1 #type").val("si");
                    $("#myModal1 h4").html("Sales Invoice");
                    $("#challantype").parent().hide();
                    $("#transdiv").hide();
                    
                });
                $("#advre").click(function(){
                    $("#myModal1 #type").val("ar");
                    $("#myModal1 h4").html("Advance Receipt");
                    $("#challantype").parent().hide();    
                    $("#transdiv").hide();
                });
                $("#delch").click(function(){
                    $("#myModal1 #type").val("dc");
                    $("#myModal1 h4").html("Delivery Challan");
                    $("#challantype").parent().show();
                    $("#transdiv").show();
                });
                $("#proin").click(function(){
                    $("#myModal1 #type").val("pr");
                    $("#myModal1 h4").html("Proforma");
                    $("#challantype").parent().hide();
                    $("#transdiv").hide();
                });
...
//                });
                $("#est").click(function(){
                    $("#myModal1 #type").val("est");
                    $("#myModal1 h4").html("Estimate");
                    $("#challantype").parent().hide();
                    $("#transdiv").hide();
                });
...
<!--            <a href="banking.jsp">Banking</a>
        ...
        <% if(request.getSession(false)!=null && session.getAttribute("email") != null){
            if(session.getAttribute("privv").toString().contains("sale") || session.getAttribute("type").equals("admin") || session.getAttribute("type").equals("multi")){
        %>
        <div class="col-12 col-lg-12 col-xl-10" id="main"> 
            <div>
                ...
                <div class="dropdown" style="display: inline-block">
                    ...
                    <div class="dropdown-menu">
                      <a id="sal" class="dropdown-item" href="#" data-toggle="modal" data-target="#myModal1">Sales Invoice</a>
                      <a id="advre" class="dropdown-item" href="#" data-toggle="modal" data-target="#myModal1">Advance Receipts</a>
                      <a id="delch" class="dropdown-item" href="#" data-toggle="modal" data-target="#myModal1">Delivery Challan</a>
                      <a id="proin" class="dropdown-item" href="#" data-toggle="modal" data-target="#myModal1">Proforma Invoice</a>
                      <a id="est" class="dropdown-item" href="#" data-toggle="modal" data-target="#myModal1">Estimates</a>
                      ...
                      <a id="samend" class="dropdown-item" href="#" data-toggle="modal" data-target="#myModal1">Sales Amendment</a>
            ...
            <div class="table_div col-12 col-lg-8 col-xl-9">                
                ...
                %>
                    <div> 
                        ...
                        <div class="collapse itemdiv">  
                            <div>
                                <div>
                                    ...
                                    <p>Shipping address same as billing address-<span class="ibill"><%out.println(obj2.getbill());%></p>                                
                                </div>
                                <div>
                                    <h5>Billing info</h5>
                                    <p>Address-<span class="ibaddr"><%out.println(obj2.getbilladdress());%></p>
                                    <p>State-<span class="ibstate"><%out.println(obj2.getbillstate());%></p>
                                    <p>City-<span class="ibcity"><%out.println(obj2.getbillcity());%></p>
                                    <p>Pin-<span class="ibpin"><%out.println(obj2.getbillpincode());%></p>                                
                                    <p>State Code-<span class="ibstatecode"><%out.println(obj2.getbillstatecode());%></p>                                
                                </div>
                                <div>
                                    <h5>Transportation info</h5>
                                    <p>Transporter-<span class="itransby"><%out.println(obj2.gettransby());%></p>
                                    <p>Charge-<span class="itranscharge"><%out.println(obj2.gettranscharge());%></p>
                                </div>
                            </div>
                            <div>
                                <%if(obj2.getbill()){%>
                                ...
                                <%}%>
                                    <h5>Shipping info</h5>
                                    <p>Address-<span class="isaddr"><%out.println(obj2.gettransaddress());%></p>
                                    <p>State-<span class="isstate"><%out.println(obj2.gettransstate());%></p>
                                    <p>City-<span class="iscity"><%out.println(obj2.gettranscity());%></p>
                                    <p>Pin-<span class="ispin"><%out.println(obj2.gettranspincode());%></p>                                
                                    <p>State Code-<span class="istatecode"><%out.println(obj2.gettransstatecode());%></p>                                
                                </div>
                                <div>
                                    <h5>Additional info</h5>
                                    <p>Advanced-<%out.println("<span class=\"iadvanced\">"+obj2.getinvoicesetting()+"</span>");%></p>
                                    <p>Challan type-<span class="ichallantype"><%out.println(obj2.getchallantype());%></p>
                                    <p>Roundoff-<span class="iroundoff"><%out.println(obj2.getroundoff());%></p>
                                    <p>Export type-<span class="iexporttype"><%out.println(obj2.getexporttype());%></p>
                                </div>
                                <div style="display: none;">
                                    <h5>Export info</h5>
                                    <p>Shipping bill no-<span class="ibillno"><%out.println(obj2.getshipbillno());%></p>
                                    <p>Shipping port code-<span class="iportcode"><%out.println(obj2.getshipportcode());%></p>
                                    <p>Shipping bill date-<%if(obj2.getshipbilldate()!=null){
                                            out.println("<span class=\"ibilldate\">"+obj2.getshipbilldate().toString().substring(0, 10)+"</span>");
                                    }else{
                                        out.println("<span class=\"ibilldate\"></span>");
                                    }%>                                
                                    </p>
                                </div>
                            </div>
                        ...
                        <span class="editsales"><i class="fas fa-edit"></i></span>
                        <span class="viewtrans">Transactions</span>
                        <span class="saleinvoice">Invoice</span>
            ...
            <div class="table_div col-12 col-lg-4 col-xl-3" style="padding:0;">
                <span style="display: none" id="transtype">sale</span>
                <div>
                    <h5>
                        Transactions
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            ...
                            <div class="sales_div">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="baddr">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="bpin">Billing pin</label>
                                    <input type="number" class="form-control" id="bpin">
                                </div>
                                <div class="form-group">
                                    <label for="bstatecode">Billing state code</label>
                                    <input type="text" class="form-control" id="bstatecode">
                                </div>
                            </div>
                            <div class="sales_div" style="clear:both;width:100%;">
                                <div class="form-group">
                                    <label for="bill">Shipping address same as billing address</label>
                                    <input type="checkbox" class="form-control" id="bill" checked>
                                </div>
                            </div>
                        </div>
                        <div style="clear:both;"> 
                            <div class="sales_div" id="salesdiv"> 
                                <h5>Shipping info</h5>                                                                                    
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="spin">Shipping pin</label>
                                    <input type="number" class="form-control" id="spin">
                                </div>
                                <div class="form-group">
                                    <label for="sstatecode">Shipping state code</label>
                                    <input type="text" class="form-control" id="sstatecode">
                                </div>
                            </div>
                             <div class="sales_div" id="transdiv"> 
                                <h5>Transportation info</h5>                                                                                    
                                <div class="form-group">
                                    <label for="transby">Transported by</label>
                                    <input type="text" class="form-control" id="transby" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="sales_div">
                                ...
                                <div class="form-group" style="display: none;">
                                    ...
                                    <select id="challantype" class="form-control">
                                        <option value="others">Others</option>
                                        <option value="job work">Job Work</option>
                                        <option value="supply on approval">Supply on Approval</option>
                                        <option value="supply on liquid gas">Supply on Liquid Gas</option>
                                    </select>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="sales_div" id="exportdiv">                                
                            <h5>Export info</h5>
                            <div class="form-group">
                                <label for="sbbillno">Shipping bill no</label>
                                <input type="text" class="form-control" id="sbillno">
                            </div>
                            <div class="form-group">
                                <label for="spcode">Shipping port code</label>
                                <input type="text" class="form-control" id="spcode">
                            </div>
                            <div class="form-group">
                                <label for="sbilldate">Shipping bill date</label>
                                <input type="date" class="form-control" id="sbilldate">
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" id="addsales" value="insert">Save</button>
                    </div>
        ...
        <div class="modal fade" id="myModal3">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="addtrans" value="sale">Save</button>
                </div>
              </div>
            </div>
        </div>    
